    ...
    <section className="relative py-16 px-8 overflow-hidden bg-[#f8f9fb]">
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex justify-between items-start mb-10">
          <div>
            <p className="text-[var(--theme-primary)] font-semibold text-sm tracking-wide mb-2">OUR EVENTS</p>
          ...
          <button className="bg-[var(--theme-primary)] text-white px-5 py-2.5 rounded flex items-center gap-1 text-sm font-medium hover:bg-[var(--theme-primary2)] transition-colors">
            View All
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 rounded-full border-2 border-[var(--theme-primary)] bg-white flex items-center justify-center text-[var(--theme-primary)] hover:bg-[var(--theme-primary)] hover:text-white transition-colors shadow-md"
          >
              ...
              {[...events, ...events].map((event, index) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <a
                      href="#"
                      className="text-[var(--theme-primary)] text-sm font-medium inline-flex items-center gap-1 hover:underline"
                    >
                      Read More
                      <ChevronsRight className="w-4 h-4" />
                    </a>
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 rounded-full bg-[var(--theme-primary)] flex items-center justify-center text-white hover:bg-[var(--theme-primary2)] transition-colors shadow-md"
          >
