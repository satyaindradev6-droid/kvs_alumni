...
export function Navbar() {
  ...
  return (
    <header className="w-full">
      ...
      <div className="h-12 bg-gradient-to-r from-[var(--theme-primary)] via-[var(--theme-secondary)] to-[var(--theme-primary)] bg-[length:200%_100%] animate-gradient flex items-center justify-between px-6">
        <style jsx>{`
          @keyframes gradient {
      ...
      <div className="bg-white py-4 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            <button onClick={() => router.push('/')} className="text-[#2c3e6e] font-medium hover:text-[#1a2a4e] transition-colors">
              Home
            </button>
            <button onClick={() => { }} className="text-[#2c3e6e] font-medium hover:text-[#1a2a4e] transition-colors">
              Member
            </button>
            <button onClick={() => { }} className="text-[#2c3e6e] font-medium hover:text-[#1a2a4e] transition-colors">
              Events
